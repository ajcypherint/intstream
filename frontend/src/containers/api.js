...
export const INDJOB_ADD_URI = '/indjobversions_add'
export const INDJOB_PARENT_URI = '/sources_indjob'
...
export const USER_INFO_API = '/api/userinfo/'
...
export const MITIGATE_INDICATOR_API = '/api/mitigate/'
