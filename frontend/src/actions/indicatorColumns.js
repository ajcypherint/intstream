...
export const getColText = (params = undefined) => {
  // filters - list[string]
  const url = setParams(COL_TEXT_API_URL, params)
  return {
    [RSAA]: {
      endpoint: url,
      method: 'GET',
...
export const getColNumeric = (params = undefined) => {
  // filters - list[string]
  const url = setParams(COL_NUM_API_URL, params)
  return {
    [RSAA]: {
      endpoint: url,
      method: 'GET',
...
export const getColTextName = (params = undefined) => {
  // filters - list[string]
  const url = setParams(COL_TEXT_NAME_API_URL, params)
  return {
    [RSAA]: {
      endpoint: url,
      method: 'GET',
...
export const getColNumericName = (params = undefined) => {
  // filters - list[string]
  const url = setParams(COL_NUM_NAME_API_URL, params)
  return {
    [RSAA]: {
      endpoint: url,
      method: 'GET',
