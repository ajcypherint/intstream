...
import { Table, FormGroup, Container, Button, Row, Pagination, PaginationItem, PaginationLink, Input } from 'reactstrap'
...
class SourcesList extends Component {
  ...
  componentDidMount () {
    ...
    const ordering = this.props.query.ordering || 'name'
  ...
  render () {
    ...
    const { ordering } = this.props.query
        ...
        {totalcount
          ? this.paginate(totalcount,
            ...
            this.props.fetchSourcesFullUri,
            {
              ...
              ordering: this.props.query.ordering
            }, // selections
            this.props.setQuery)
          : ''}
