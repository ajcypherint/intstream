...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    {
      const new_classif = addResults(action.payload.classif, state.classif)
      return {
        ...state,
        classif: new_classif,
        totalLoading: false,
    ...
    {
      const new_classif = remove(action.meta.id, state.classif)
      return {
        ...state,
        classif: new_classif,
        errors: {}
    ...
    {
      // todo
      const new_classif = addResults([action.payload], state.classif)
      return {
        ...state,
        classif: new_classif,
        totalLoading: false,
