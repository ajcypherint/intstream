...
router.register("indicatorjob", views.StandardIndicatorJobViewSet, basename="indicatorjob")
router.register("mitigateindicatorjob", views.MitigateIndicatorJobViewSet, basename="mitigateindicatorjob")
router.register("unmitigateindicatorjob", views.UnmitigateIndicatorJobViewSet, basename="unmitigateindicatorjob")
router.register("indicatorjobversion", views.StandardIndicatorJobVersionViewSet, basename="indicatorjobversion")
router.register("mitigateindicatorjobversion", views.MitigateIndicatorJobVersionViewSet, basename="mitigateindicatorjobversion")
router.register("unmitigateindicatorjobversion", views.UnmitigateIndicatorJobVersionViewSet, basename="unmitigateindicatorjobversion")
